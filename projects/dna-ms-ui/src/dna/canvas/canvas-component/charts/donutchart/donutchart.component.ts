...
export class CanvasDonutchartComponent extends CanvasWidgetClass
  implements OnInit {
  overStyle: any;
  donutChartData: any;
  ...
  constructor(
    ...
    this.properties = new DonutchartProperty();
    this.dataSource = new DonutchartDatasource();
  }
  ngOnInit() {
    this.componentId =
...
export class DonutchartProperty extends CanvasWidgetClass
...
export class DonutchartDatasource extends DatasourceModel {
  dataReader: string;
  metadata: any;
  servicetype: any;
  localDataName: any;
