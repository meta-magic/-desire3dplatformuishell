...
var CanvasColumnchartComponent = (function (_super) {
    __extends(CanvasColumnchartComponent, _super);
    function CanvasColumnchartComponent(_eventHndl, _componentFactoryResolver) {
        var _this = _super.call(this) || this;
        _this._eventHndl = _eventHndl;
        _this._componentFactoryResolver = _componentFactoryResolver;
        _this.mouseLocation = { left: 0, top: 0 };
        _this.componentBehaviour.isBindingComponent = true;
        _this.columnChartData = [
            [
        ...
        _this.properties = new ColumnchartProperty();
        _this.dataSource = new ColumnchartDatasource();
        return _this;
    }
    CanvasColumnchartComponent.prototype.ngOnInit = function () {
        this.componentId =
            +Math.floor(Math.random() * 90000) + 10000 + '_' + this.name;
    };
    CanvasColumnchartComponent.prototype.onHover = function () {
        this.showContextMenu = false;
    };
    CanvasColumnchartComponent.prototype.getContextMenuStyle = function () {
        return {
            position: 'fixed',
    ...
    CanvasColumnchartComponent.prototype.loadContextMenu = function (event) {
    ...
    CanvasColumnchartComponent.prototype.onDeleteClick = function () {
        this.showContextMenu = false;
        this._eventHndl.componentIdToDel = this.componentId;
        this._eventHndl.deleteComponent();
        this._eventHndl.addEditorNewState();
    };
    CanvasColumnchartComponent.prototype.setSelfActive = function (event) {
        event.stopPropagation();
    ...
    CanvasColumnchartComponent.prototype.loadComponentProperties = function () {
    ...
    CanvasColumnchartComponent.prototype.componentElementDraggedOver = function (event) {
        event.preventDefault();
    };
    return CanvasColumnchartComponent;
}(canvas_widget_class_1.CanvasWidgetClass));
__decorate([
    core_1.HostListener('document:click')
], CanvasColumnchartComponent.prototype, "onHover");
CanvasColumnchartComponent = __decorate([
    core_1.Component({
...
exports.CanvasColumnchartComponent = CanvasColumnchartComponent;
var ColumnchartProperty = (function (_super) {
    __extends(ColumnchartProperty, _super);
    function ColumnchartProperty() {
        var _this = _super.call(this) || this;
    ...
    return ColumnchartProperty;
}(canvas_widget_class_1.CanvasWidgetClass));
exports.ColumnchartProperty = ColumnchartProperty;
var ColumnchartDatasource = (function (_super) {
    __extends(ColumnchartDatasource, _super);
    function ColumnchartDatasource() {
        var _this = _super.call(this) || this;
    ...
    return ColumnchartDatasource;
}(datasource_model_1.DatasourceModel));
exports.ColumnchartDatasource = ColumnchartDatasource;
