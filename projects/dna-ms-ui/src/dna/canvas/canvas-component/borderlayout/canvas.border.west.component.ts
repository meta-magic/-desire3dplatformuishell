...
export class CanvasWestComponentComponent extends CanvasWidgetClass
  implements OnInit, OnDestroy {
  componentOverStyle: any;
  showContextMenu: boolean;
  name = 'borderWest';
  mouseLocation: { left: number; top: number } = { left: 0, top: 0 };
  @ViewChild('westborder', { read: ViewContainerRef })
  target: any;
  constructor(
    ...
    super();
    this.properties = new BorderWestProperties();
  }
...
export class BorderWestProperties {
