...
export class CanvasDataPointWestComponentComponent extends CanvasWidgetClass
  implements OnInit, OnDestroy {
  componentOverStyle: any;
  showContextMenu: boolean;
  name = 'dataWest';
  mouseLocation: { left: number; top: number } = { left: 0, top: 0 };
  @ViewChild('westdata', { read: ViewContainerRef })
  target: any;
  constructor(
    ...
    super();
    this.properties = new DataWestProperties();
  }
...
export class DataWestProperties {
