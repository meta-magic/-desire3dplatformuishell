...
var DatapointEastPropertyComponent = (function () {
    function DatapointEastPropertyComponent() {
        this.alignment = [];
        this.alignment = [
            {
                type: 'center',
    ...
    DatapointEastPropertyComponent.prototype.ngOnInit = function () { };
    DatapointEastPropertyComponent.prototype.onNorthChange = function (flag) {
        var _this = this;
        if (!flag) {
    ...
    DatapointEastPropertyComponent.prototype.onEastChange = function (flag) {
        var _this = this;
        if (!flag) {
            this.componentInstance.children.forEach(function (child) {
                if (child.instance.hasOwnProperty('children') &&
    ...
    DatapointEastPropertyComponent.prototype.onCenterChange = function (flag) {
        var _this = this;
        if (!flag) {
            this.componentInstance.children.forEach(function (child) {
                if (child.instance.hasOwnProperty('children') &&
    ...
    DatapointEastPropertyComponent.prototype.onWestChange = function (flag) {
        var _this = this;
        if (!flag) {
            this.componentInstance.children.forEach(function (child) {
                if (child.instance.hasOwnProperty('children') &&
    ...
    DatapointEastPropertyComponent.prototype.onSouthChange = function (flag) {
        var _this = this;
        if (!flag) {
            this.componentInstance.children.forEach(function (child) {
                if (child.instance.hasOwnProperty('children') &&
    ...
    DatapointEastPropertyComponent.prototype.deleteInstances = function (child) {
        var _this = this;
    ...
    return DatapointEastPropertyComponent;
}());
DatapointEastPropertyComponent = __decorate([
    core_1.Component({
        selector: 'datapoint-east-property',
...
exports.DatapointEastPropertyComponent = DatapointEastPropertyComponent;
