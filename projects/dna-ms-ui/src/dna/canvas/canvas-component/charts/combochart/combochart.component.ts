...
export class CanvasCombochartComponent extends CanvasWidgetClass
  implements OnInit {
  overStyle: any;
  comboChartData: any;
  ...
  constructor(
    ...
    this.properties = new CombochartProperty();
    this.dataSource = new CombochartDatasource();
  }
  ngOnInit() {
    this.componentId =
...
export class CombochartProperty extends CanvasWidgetClass
...
export class CombochartDatasource extends DatasourceModel {
  dataReader: string;
  metadata: any;
  servicetype: any;
  localDataName: any;
