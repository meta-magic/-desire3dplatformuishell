...
var TimelinechartPropertyComponent = (function () {
    function TimelinechartPropertyComponent() {
    }
    TimelinechartPropertyComponent.prototype.ngOnInit = function () { };
    TimelinechartPropertyComponent.prototype.propertyValidation = function () {
        this.componentInstance._eventHndl.componentValidation(this.componentInstance);
    };
    return TimelinechartPropertyComponent;
}());
TimelinechartPropertyComponent = __decorate([
    core_1.Component({
...
exports.TimelinechartPropertyComponent = TimelinechartPropertyComponent;
