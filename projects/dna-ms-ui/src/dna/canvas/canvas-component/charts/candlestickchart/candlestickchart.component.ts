...
export class CanvasCandlestickchartComponent extends CanvasWidgetClass
  implements OnInit {
  overStyle: any;
  ...
  constructor(
    ...
    this.properties = new CandlestickchartProperty();
    this.dataSource = new CandlestickchartDatasource();
  }
  ngOnInit() {
    this.componentId =
...
export class CandlestickchartProperty extends CanvasWidgetClass
...
export class CandlestickchartDatasource extends DatasourceModel {
  dataReader: string;
  metadata: any;
  servicetype: any;
  localDataName: any;
