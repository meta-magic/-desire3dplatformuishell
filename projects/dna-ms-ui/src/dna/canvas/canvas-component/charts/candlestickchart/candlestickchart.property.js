...
var CandlestickchartPropertyComponent = (function () {
    function CandlestickchartPropertyComponent() {
    }
    CandlestickchartPropertyComponent.prototype.ngOnInit = function () { };
    CandlestickchartPropertyComponent.prototype.propertyValidation = function () {
        this.componentInstance._eventHndl.componentValidation(this.componentInstance);
    };
    return CandlestickchartPropertyComponent;
}());
CandlestickchartPropertyComponent = __decorate([
    core_1.Component({
        selector: 'candlestick-chart-property',
...
exports.CandlestickchartPropertyComponent = CandlestickchartPropertyComponent;
