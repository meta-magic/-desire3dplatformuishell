...
var DnaNotificationComponent = (function () {
    function DnaNotificationComponent(_notificationService) {
        this._notificationService = _notificationService;
    }
    DnaNotificationComponent.prototype.ngOnInit = function () { };
    return DnaNotificationComponent;
}());
DnaNotificationComponent = __decorate([
    core_1.Component({
        selector: 'dna-notification',
...
exports.DnaNotificationComponent = DnaNotificationComponent;
