...
export class CanvasPiechartComponent extends CanvasWidgetClass
  implements OnInit {
  overStyle: any;
  pieChartData: any;
  ...
  constructor(
    ...
    this.properties = new PiechartProperty();
    this.dataSource = new PiechartDatasource();
  }
  ngOnInit() {
    this.componentId =
...
export class PiechartProperty extends CanvasWidgetClass
...
export class PiechartDatasource extends DatasourceModel {
  dataReader: string;
  metadata: any;
  servicetype: any;
  localDataName: any;
