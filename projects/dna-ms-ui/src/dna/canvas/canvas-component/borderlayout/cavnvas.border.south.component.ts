...
export class CanvasSouthComponentComponent extends CanvasWidgetClass
  implements OnInit, OnDestroy {
  componentOverStyle: any;
  showContextMenu: boolean;
  name = 'borderSouth';
  mouseLocation: { left: number; top: number } = { left: 0, top: 0 };
  @ViewChild('southborder', { read: ViewContainerRef })
  target: any;
  constructor(
    ...
    super();
    this.properties = new BorderSouthProperties();
  }
...
export class BorderSouthProperties {
