...
export class CanvasBarchartComponent extends CanvasWidgetClass
  implements OnInit {
  overStyle: any;
  barChartData: any;
  ...
  constructor(
    ...
    this.properties = new BarchartProperty();
    this.dataSource = new BarchartDatasource();
  }
  ngOnInit() {
    this.componentId =
...
export class BarchartProperty extends CanvasWidgetClass
...
export class BarchartDatasource extends DatasourceModel {
  dataReader: string;
  metadata: any;
  servicetype: any;
  localDataName: any;
