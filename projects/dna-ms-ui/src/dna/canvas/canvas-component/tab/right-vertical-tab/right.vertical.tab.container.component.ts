...
export class CanvasVerticalRightTabComponent extends CanvasWidgetClass
  ...
  constructor(
    ...
    super();
    this.properties = new VerticalRightTabProperties();
  }
...
export class VerticalRightTabProperties {
