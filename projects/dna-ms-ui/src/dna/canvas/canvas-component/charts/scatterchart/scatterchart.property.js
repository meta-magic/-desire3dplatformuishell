...
var ScatterchartPropertyComponent = (function () {
    function ScatterchartPropertyComponent() {
    }
    ScatterchartPropertyComponent.prototype.ngOnInit = function () { };
    ScatterchartPropertyComponent.prototype.propertyValidation = function () {
        this.componentInstance._eventHndl.componentValidation(this.componentInstance);
    };
    return ScatterchartPropertyComponent;
}());
ScatterchartPropertyComponent = __decorate([
    core_1.Component({
        selector: 'scatter-chart-property',
...
exports.ScatterchartPropertyComponent = ScatterchartPropertyComponent;
