/**
 * Created by dattaram on 24/10/18.
 */
...
export class ConBehaviourComponent implements OnInit {
  ...
  constructor(
    public _eventRelationshipService: EventRelationshipService,
